...
const SearchBar = () => {
  ...
  const testissItem = useSelector((state) => state.TestimonialReducermenu.testimonialDataList )
  ...
  const filteredTestissData = testissItem.filter((item) => item.title.toLowerCase().includes(searchQuery.toLowerCase()) )
